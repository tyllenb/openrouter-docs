# OAuth Integration
Integrate OAuth into your application and give developers tons of models to provide to their users.
<br />

<iframe
  width="800"
  height="460"
  src="https://www.youtube.com/embed/nYfVzLFab5A?si=u2M35F3MRwte5VyE"
...
<Card
title="OAuth Example Github"
icon={faGithub}
description="Click here to view the Github this guide is based on."
href="https://github.com/tyllenb/openrouter-oauth-pkce-next.js"
/>
...
This integration is designed to enable developers to quickly integrate OpenRouter's OAuth PKCE authentication and access a wide range of AI models provided by OpenRouter. It's built using [Next.js](https://nextjs.org/), a popular React framework, and provides a streamlined way to authenticate users and retrieve responses from OpenRouter's AI APIs. 

import { Callout } from 'nextra/components'

<Callout type="info" emoji="ℹ️">
Here we are storing API Keys returned to us in local storage just for testing and educational purposes. For production use cases it is recommended to integrate into a seperate backend to store these keys and not have them exposed!
</Callout>
...
<Callout type="info" emoji="ℹ️">
The system setting for the model response is set to respond in fun Gen-Z slang. You can update it to however you'd like it to respond to you in, it's set like that for now because who doesn't like lit responses? No cap! 🔥
</Callout>
